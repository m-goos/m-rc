---
title: A roadmap for learning Angular
date: 2021-01-05
description: Get familiar with the most important concepts in Angular, fast.
---

# A roadmap for learning Angular
...
|                ![Hop on](/blog/how-to-master-angular-first-month/metro.jpeg)                 |
| :------------------------------------------------------------------------------------------: |
...
Guided by my team lead with 10+ years of experience, my introduction to Angular can be seen as a very effective one-month bootcamp. It works best for me to blend different kinds of resources and you will probably have your personal preference on how to balance these resources. Besides, it is useful to think about your learning style and how new information sticks best, before you dive in. Reflecting on this ahead of time will greatly improve your learning curve, is my experience.
...
4. Start a personal project (see paragraph below), because _building_ is better than just _knowing_.
...
For learning Angular, it should not matter much what kind of Operating System and IDE you use. I currently work on a MacBook pro, writing code in VS Code. But let's not get into the details of that here, just set up your machine as you please. Check out [this](https://TODO) blog for my setup guide.
...
| ![Angular](/blog/how-to-master-angular-first-month/angular-state-of-js-1.png) |
| :---------------------------------------------------------------------------: |
