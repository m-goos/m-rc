---
title: Setting up a MacBook for Front End JavaScript development
date: 2020-10-10
description: Tools, system configuration tweaks and VSCode keybindings
---

[mos-1]: /blog/macbook-setup-for-fullstack-development/mos-1.png 'Mos preferences'
[mos-2]: /blog/macbook-setup-for-fullstack-development/mos-2.png 'Mos preferences advanced'
[tools]: /blog/macbook-setup-for-fullstack-development/tools.jpeg 'Setting up our tools'
[touchbar-1]: /blog/macbook-setup-for-fullstack-development/touchbar-1.png 'Navigating to touchbar settings'
[touchbar-2]: /blog/macbook-setup-for-fullstack-development/touchbar-2.png 'customizing touchbar settings'
[touchbar-3]: /blog/macbook-setup-for-fullstack-development/touchbar-3.png 'Touchbar settings menu'
[touchbar-screenshot]: /blog/macbook-setup-for-fullstack-development/touchbar-screenshot.png 'Screenshot of touchbar setup'
[trackpad-1]: /blog/macbook-setup-for-fullstack-development/trackpad-1.png 'Navigating to trackpad settings'
[trackpad-2]: /blog/macbook-setup-for-fullstack-development/trackpad-2.png 'Enabling three finger drag'
[vscode-settings]: /blog/macbook-setup-for-fullstack-development/vscode-settings.png 'Accessing VS Code settings through command palette'
[zsh]: /blog/macbook-setup-for-fullstack-development/zsh.png 'Z Shell after changing the configuration'

# Setting up a MacBook for Front End JavaScript development

In the past months, I set up a MacBook for full stack JavaScript development five times — technical difficulties, 🍾 a new job, a new computer at a client, you name it. If, like me, you have hobbies, this is not the thing you want to be spending your time on. So the next time I am setting up a machine, I will be copy-pasting from this article. Or, even better, automating the setup. I hope this saves you some time too, and that you pick up a trick or two. This article discusses:
...
| :-------------------------------------: | :-----------------------------: |
| _Indepenedent and horizontal scrolling_ |                                 |
...
| :----------------------------------------------: | :----------------------------------------------: | :----------------------------------------------: |
|        _Customzing the touchbar settings_        |
...
| :--------------------------------------------------------------------------: |
| _Buttons: Media — Brightness Slider — Do Not Disturb — Volume — Screen Lock_ |
...
|![][zsh]|
:--:
|_Z Shell after changing the configuration_|
...
Now you can either `Open User Settings` and configure your preferences, or open the JSON file to edit your settings. I use these settings ([gist](https://gist.github.com/mhlgoossens/b8ca7feabe67aead8b556301c5752e15)) to enable settings such as Word Wrap, Auto Save, Tab Size and hiding the Mini Map on the right hand side.
